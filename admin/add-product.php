                        ...
                        <div class="col">
                            <div class="home_content">
                                <div class="breadcrumbs">
                                    <ul>
                                        <li style="font-size: 40px;">Add Product</li>
                                        <!-- <li>Login</li> -->
                                    </ul>
                                </div>
                            </div>
...
<div style="padding-bottom:20px;">   
             ...
             <div style="padding-bottom:20px;"> 
                <span class="pass">Product Category</span>
             ...
             <div style="padding-bottom:20px;"> 
                <span class="pass">Product Description</span>
                <input type="textarea"  name="productdesc" value="">
            </div>

             <div style="padding-bottom:20px;"> 
                <span class="pass">Product Price</span>
                <input type="number"  name="productprice" value="">
            </div>


             <div style="padding-bottom:20px;"> 
                <span class="pass">Product Image</span>
                <input type="text"  name="productimg" value="">
            </div>

             <div style="padding-bottom:20px;"> 
                <span class="pass">Product Quantity</span>
                <input type="number"  name="productqty" value="">
            </div>

             <div style="padding-bottom:20px;"> 
                <span class="pass">Availability</span>
