                        ...
                        <div class="col">
                            <div class="home_content">
                                <div class="breadcrumbs">
                                    <ul>
                                        <li style="font-size: 40px;">Update Order</a></li>
                                        <!-- <li>Login</li> -->
                                    </ul>
                                </div>
                            </div>
				...
				<div class="table100">
					<table>
                        ...
                        <tbody>
                            ...
                            {
                                $id=$_GET["editid"];
                                $result=mysqli_query($connect,"SELECT * FROM userorder WHERE Order_ID=$id");
                            }
                    ...
                    <button name="savebtn" class="submitbutton">Update</button>
...
if(isset($_POST["savebtn"]))
{
    ...
    //use mysqli_query to update movie
    mysqli_query($connect,"UPDATE userorder SET Order_Status='$status' WHERE Order_ID=$id");
?>
    <script>
