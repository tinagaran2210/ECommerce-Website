      ...
      <div class="row">
        <div class="col">
          ...
          <div class="product_grid">
            <?php   
  $result=mysqli_query($connect,"SELECT * FROM products WHERE (product_id, product_name) in ( SELECT MIN(product_id), product_name FROM products GROUP BY product_name  )AND product_category='Accessory'");
