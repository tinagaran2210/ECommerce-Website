...
while($rowcat = mysqli_fetch_assoc($resultcat))
{
 ...
 ?>      
          ...
          <a href="login-catproduct.php?view&proid=<?php echo $rowcat['category_name'] ?>"><input class="button contact_button1" type="button" name="pending" value="<?php echo $rowcat["category_name"];?>"></a>
<?php 
}
?>
        </div>
