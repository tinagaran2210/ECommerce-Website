        ...
        <div class="col-lg-8 offset-lg-2">
          <div class="newsletter_content text-center">
            <div class="newsletter_form_container">
              <form method="post"> 
       <div class="register-top-grid" style="background-color: black;width:50%;text-align: center;">
      <h2>MY ACCOUNT</h2>
       ...
       <div>
            ...
            <div style="clear:both">
                <span>Password</span>
                <p><a href="change_password.php" style="color:blue">Change Password</a></p>
            </div>
