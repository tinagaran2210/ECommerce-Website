      ...
      <div class="wrap-table100">
        <div class="table100">
          <table>
            ...
            <?php
                ...
                //
                 if(isset($_GET['det']) ){
                     ...
                     $idd=$_GET['oid'];
                     $detail = mysqli_query($connect,"SELECT * FROM orderdetail WHERE Order_ID ='$idd' ");
                     $d  = mysqli_query($connect,"SELECT * FROM userorder WHERE Order_ID ='$idd' "); 
                     $gtotal = mysqli_fetch_assoc($d);
                 }
               $tot=0.0;
            ...
            <tr >
                        <td >&nbsp;<?php echo $num; ?></td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row["detail_Product_Name"];?></td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row["detail_Product_Quantity"];?></td>          
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row["detail_Product_Price"];?></td>
            ...
            ?>
                ...
                <tr>
                    <td colspan="3"  align="left" style="padding-left:800px">&nbsp;&nbsp;&nbsp;&nbsp;<b>Shipping Fee</b></td>   
                    <td colspan="1" align="left">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ship;?></td>   
                </tr>
                <tr>
                    <td colspan="3"  align="right" style="padding-left:800px">&nbsp;&nbsp;&nbsp;<b> Grand Total</b></td>   
                    <td colspan="1" align="left">&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $gtotal["Order_Price"];?></b></td>   
                </tr>
