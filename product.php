<?php
    ...
    if(isset($_GET['view'])) 
        {
            $id = $_GET["proid"];
            // $new = str_replace('%20', 's', $id);
            $result = mysqli_query($connect, "SELECT * FROM products WHERE product_name='$id'");
            ...
            <div class="product">
            	<h1><?php echo $row['product_name']; ?></h1>
							...
							<div class="product_content">
								<div class="product_price"><?php echo "".$row['product_name']; ?></div>
								<div class="product_price"><?php echo "".$row['product_brand']; ?></div>

								<div class="product_price">From RMvv 3599</div>
							</div>
						</div>
