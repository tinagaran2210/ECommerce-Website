...
<?php   
	$result=mysqli_query($connect,"SELECT * FROM brands"); 
                while($row=mysqli_fetch_assoc($result))  { ?>
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="images/<?php echo $row['brand_img'];?>" alt="" style="height:261px;width:263px;"></div>
							<div class="product_content">
								<div class="product_title"><a href="xs.php"><?php echo "".$row['brand_name']; ?></div>
								<div class="product_price">From RM 3599</div>
...
?>
						...
						<!-- <div class="product">
							<div class="product_image"><img src="images/xs.jfif" alt="" style="height:261px;width:263px;"></div>
							<div class="product_extra product_new"><a href="categories.html">New</a></div>
							<div class="product_content">
								<div class="product_title"><a href="xs.php">iPhone XS</a></div>
								<div class="product_price">From RM 4999</div>
							</div>
						</div> -->

						<!-- Product -->
						<!-- <div class="product">
							<div class="product_image"><img src="images/xsmax.png" alt="" style="height:261px;width:263px;"></div>
							<div class="product_content">
								<div class="product_title"><a href="xsmax.php">iPhone XS Max</a></div>
								<div class="product_price">From RM 5399</div>
							</div>
						</div>
 -->
						<!-- Product -->
					<!-- 	<div class="product">
							<div class="product_image"><img src="images/iphone8.jfif" alt=""style="height:261px;width:263px;"></div>
							<div class="product_content">
								<div class="product_title"><a href="8.php">iPhone 8</a></div>
								<div class="product_price">From RM 2899</div>
							</div> -->
							<!-- <?php   
	$result=mysqli_query($connect,"SELECT * FROM products"); 
                while($row=mysqli_fetch_assoc($result))  {
                	...
                	<div class="mask1"><img src="images/<?php echo $row['product_img'];?>" ></div>
                	<?php
                }
?> -->
						</div>
