<?php
    ...
    $result2=mysqli_query($connect,"SELECT COUNT(cart_id) from cart");
...
<div class="super_container">
                ...
                <ul>
                  <li>
									...
									<li class="hassubs">
										<a href="#">Categories</a>
										<ul>
											<li><a href="login-smartphones.php">Smartphones</a></li>
											<li><a href="login-accessories.php">Accessories</a></li>
										</ul>
									</li>
                    ...
                    <ul>
                      ...
                      <li><a href="orders.php">My Orders</a></li><li><a href="index.html">Logout</a></li>
                    </ul>
              </nav>
              <div class="header_extra ml-auto">
                <div class="shopping_cart">
                  <a href="cart.php">
                    ...
                    <div>Cart <span>(<?php echo $row2['COUNT(cart_id)']; ?>)</span></div>
                  </a>
                </div>
                <div class="search">
  ...
  <div class="products">
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="product_grid">
            ...
            <!-- Product -->
            <div class="product">
              <h3><a href="#"><?php echo $row['cart_product_name'];?></a></h3>
              <img lass="img-responsive"  style="width:200px;" src="images/<?php echo $row['cart_product_img'];?>" >

              
              <div class="product_content">
                <button class="button contact_button" type="submit" name="back" value="back"><span>Back</span></button><a  href="cart.php?del&cid=<?php echo $row['cart_id']?>" onclick="return confirmation();"><input  class="close1" type="button" class="button contact_button"name=""></a>
                 <ul class="qty">
                         
              <li><p>Quantity : <?php echo $row["cart_product_qty"] ?></p></li>
                            <li><p>Price : <?php echo $row['cart_product_price'] ?></p></li>
            </ul>
              </div>
            </div>
    ...
    <a class="order" href="checkout.php" id="tog" name="place">Proceed To Checkout</a>
             <?php
